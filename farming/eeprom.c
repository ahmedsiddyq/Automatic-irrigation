...
/***************************************************************************************************
void eeint(uint16_t v_eepromType_u16)
***************************************************************************************************
...
/***************************************************************************************************
  void eesave(uint16_t v_eepromAddress_u16, uint8_t v_eepromData_u8)
***************************************************************************************************
...
/***************************************************************************************************
               uint8_t eeread(uint16_t v_eepromAddress_u16)
***************************************************************************************************
...
void EEPROM_WriteString(uint16_t v_eepromAddress_u16, uint8_t *ptr_string_u8)
{
    do
    {
        eesave(v_eepromAddress_u16,*ptr_string_u8); //Write a byte from RAM to EEPROM
...
void EEPROM_ReadString(uint16_t v_eepromAddress_u16, uint8_t *ptr_destStringAddress_u8)
{
    ...
    do
    {
        eeprom_data = eeread(v_eepromAddress_u16); //Read a byte from EEPROM to RAM
